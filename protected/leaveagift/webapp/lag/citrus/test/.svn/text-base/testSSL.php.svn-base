...
CitrusPay::setApiKey("5a45567fecb08a3361398947c7d3d825bc2fa426",'sandbox');
	...
	$addressCity = 'Kanpur';
	$addressStreet1 = 'classic mild and regular';
	$addressCountry = 'India';
	$addressZip = '281016';
	$firstName = 'Gaurav';
	$lastName = 'Sharma';
	$phoneNumber = '9369024478';
	$email = 'instinct.iitk@gmail.com';
	...
	$cvvNumber = '127';
	$expiryYear = '13';
	$returnUrl = 'https://dev.leaveagift.com/payreturn/return/';
	$orderAmount = '7';
	$flag = "post";
	...
	<form action="<?php echo $action;?>" method="POST"
		...
		<p>
			<label> Merchant Access Key:</label><input name="merchantAccessKey"
				type="text" value="<? echo $merchantAccessKey ; ?>" />
		</p>
		<p>
			<label> Transaction ID:</label><input name="merchantTxnId"
				type="text" value="<? echo $merchantTxnId ;?>" />
		</p>
		<p>
