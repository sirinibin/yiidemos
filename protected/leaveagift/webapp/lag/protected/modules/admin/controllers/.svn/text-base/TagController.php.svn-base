...
class TagController extends CController
{
	...
	public function actionIndex()
	{
                ...
                if(isset($_GET['Tag']))
		{
                 ...
                 $session['Tag_records']=Tag::model()->findAll($criteria); 
        ...
        public function actionGenerateExcel()
	{
            ...
            $session->open();		
             ...
             if(isset($session['Tag_records']))
               {
                $model=$session['Tag_records'];
               }
               else
        ...
        public function actionGeneratePdf() 
	{
		...
		$pdf->SetTitle('Tag Report');
		$pdf->SetSubject('Tag Report');
