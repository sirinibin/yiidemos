...
/**
 * This is the model class for table "ps_category_product".
 *
 * The followings are the available columns in table 'ps_category_product':
...
class CategoryProduct extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_category, position', 'length', 'max'=>10),
