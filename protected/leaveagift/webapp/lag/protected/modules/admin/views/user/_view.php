<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('facebook_userid')); ?>:</b>
	<?php echo CHtml::encode($data->facebook_userid); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('facebook_oauthid')); ?>:</b>
	<?php echo CHtml::encode($data->facebook_oauthid); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('facebook_email')); ?>:</b>
	<?php echo CHtml::encode($data->facebook_email); ?>
	<br />
