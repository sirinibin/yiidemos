                                    ...
                                    <form id="form1" name="form1" method="GET" action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/auth/search/">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          ...
                                          <td><input type="image" width="100" value="submit" src="<?php echo Yii::app()->request->baseUrl; ?>/images/search-friends.gif"" alt="submit Button" width="10" height="30" border="0" ></td>
                                          </tr>
                                      </table>
                                    </form>
                                  </div>
...
{
  $i=$i+1;
  echo '<b>'.$i.'<a href="'.Yii::app()->request->baseUrl.'/index.php/product/index/id/'.$friend['uid'].'_'.$friend['birthday_date'].' ">'.$friend['name'].'</a></b></br>';
}
?>                             
