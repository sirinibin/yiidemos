  ...
  <p>
    <div class="order_confirmation_outer">
      <table width="200" align="center" cellpadding="7" cellspacing="5">
        ...
        <tr>
          <td align="center" style="color:#3fa203; font-size:20px;">We Cannot Post on Your Friend's Facebook Wall, <br /> Please provide e valid email address.</td>
          <br /> </tr>
      </table>
      <a href="<?php echo Yii::app()->createUrl('SendGift/SendGift');  ?>" ><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/back_btn.jpg" alt="" width="114" height="53" border="0" /> </a>
