...
<title>LeaveAGift - Spread Happiness</title>
<script>

  function setSelectedUser()
		  {
			 var id = <?php echo $id ?>  ;
			 var imgElem = document.getElementById("selected-friend");
			 imgElem.innerHTML = "<a href='"+ "<?php echo Yii::app()->request->baseUrl."/product/index"."/id/";?>" +id+"'><img id=\""+id+ "\"width='75' height='70' border=\"0\" src='https://graph.facebook.com/" + id + "/picture?width=75&height=70&return_ssl_results=1'></img>";
      ...
      <div class="title"><h1>Choose <?php echo Yii::app()->session['selected-username']?>'s Gift</h1>
</div>
