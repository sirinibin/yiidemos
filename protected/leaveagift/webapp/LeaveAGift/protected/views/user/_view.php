...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('oauth_id')); ?>:</b>
	<?php echo CHtml::encode($data->oauth_id); ?>
	<br />
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('profile_pic_url')); ?>:</b>
	<?php echo CHtml::encode($data->profile_pic_url); ?>
	<br />
