 ...
 * @since v1.0
 */
class NParseDataProvider extends CDataProvider
{
	/**
	...
	public function __construct($modelClass, $config = array())
	{
		...
		else if($modelClass instanceof NParse)
		{
	...
	protected function fetchData()
	{
		...
		if(($sort=$this->getSort())!==false && ($order=$sort->getOrderBy())!='')
		{
			...
			{
				$sort[$name]=$descending ? NParseCriteria::SORT_DESC : NParseCriteria::SORT_ASC;
			}
